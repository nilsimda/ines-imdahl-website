...
function Impressum({ name, email, logoUrl }) {
    ...
    return (
        <div>
            ...
            <div className="px-4 py-4">
                ...
                <p>{name}</p>
                <p className="font-bold mt-4">Vertreten durch</p>
                <p>{name}</p>
                <p className="font-bold mt-4">Kontakt:</p>
                <p>Telefon: 0221-86006-0</p>
                <p>E-Mail: {email}</p>
                <p className="font-bold mt-4">Verantwortlich für den Inhalt nach § 55 Abs. 2 RStV:</p>
                <p>{name}</p>
                <p>Hohe Straße 160-168</p>
                <p>50667 Köln</p>
                <h4 className="text-lg font-bold mt-4">Haftungsausschluss:</h4>
                <p className="font-bold mt-2">Haftung für Inhalte</p>
                <p>
                ...
                <p className="font-bold mt-4">Haftung für Links</p>
                <p>
                ...
                <p className="font-bold mt-4">Urheberrecht</p>
                <p>
                ...
                <p className="font-bold mt-4">Datenschutz</p>
                <p>
